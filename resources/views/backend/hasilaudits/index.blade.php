        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                @can($page->code.' create')
                    <a href="#" class="btn btn-primary btn-action" data-title="Tambah" data-action="create" data-url="{{ config('master.app.url.backend').'/'.$page->url }}">
        ...
        <table id="datatable" class="table align-middle table-row-dashed fs-6 gy-5">
            <thead>
                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                    <th class="w-0">No</th>
					<th class="text-center">Skor_auditee</th>
					<th class="text-center">Skor_final</th>
					<th class="text-center">Catatan_final</th>
					<th class="text-center">Status_terkini</th>
					<th class="text-center">Auditperiode</th>
