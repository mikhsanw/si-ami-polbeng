...
<div class="card">
    ...
    <div class="card-body py-4">
        <div class="row">
            @forelse($auditperiodes as $periode) {{-- Ubah $auditperiode menjadi $periode untuk konsistensi --}}
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm border-0 rounded-3">
                        <div class="card-body p-4 d-flex flex-column">
                            <h4 class="card-title fw-bold">{{ $periode->nama_periode }} ({{ $periode->tahun_akademik }})</h4> {{-- Tampilkan nama_periode dan tahun --}}
                            <p class="text-muted mb-2">Unit: {{ $periode->unit->nama ?? 'N/A' }}</p> {{-- Pastikan nama relasi unit.nama --}}
                            ...
                            <div class="mb-2">
                                <small class="text-muted">Progres Audit: {{ $periode->overall_progress }}% dari {{ $periode->total_indikator }} Indikator</small>
                            </div>
                            ...
                            <small class="text-muted mt-1 d-block">Indikator Terisi: {{ $periode->status_counts['total_terisi'] }}</small>
