        ...
        <div class="card-body py-4">
            <div class="row">
                @forelse($auditperiodes as $periode)
                    {{-- Menggunakan $periode sesuai controller --}}
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 shadow-sm border-0 rounded-3">
                            <div class="card-body p-4 d-flex flex-column">
                                ...
                                <div class="mb-2">
                                    <small class="text-muted">Progres Unit: {{ $periode->overall_progress }}% dari
                                ...
                                <div class="progress" style="height: 25px;">
                                    @php
                                        ...
                                        $p_belum =
                                            $total > 0
                                                ? round(($periode->status_counts['belum_dikerjakan'] / $total) * 100)
                                                : 0;
                                    @endphp
                                ...
                                <small class="text-muted mt-1 d-block">Indikator Terisi oleh Unit:
