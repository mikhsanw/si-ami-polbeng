...
<div class="panel">
    <div class="panel-body">
		<div class="form-group">
			{!! html()->label()->class("control-label")->for("bobot")->text("Bobot") !!}
			{!! html()->text("bobot", isset($data) ? $data->bobot : null)->placeholder("Type Bobot here")->class("form-control")->id("bobot") !!}
		</div>
		<div class="form-group">
			{!! html()->label()->class("control-label")->for("instrumen_template_id")->text("InstrumenTemplate") !!}
			{!! html()->select("instrumen_template_id", $instrumen_template_id, isset($data) ? $data->instrumen_template_id : null)->placeholder("Pilih")->class("form-control select2")->id("instrumen_template_id") !!}
		</div>
		<div class="form-group">
