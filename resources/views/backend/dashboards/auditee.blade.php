        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="col-xl-4">
                        <div class="card card-xl-stretch mb-xl-8 bg-warning h-100">
                            <div class="card-body p-5">
                                ...
                                <div class="fw-semibold text-white fs-7">Indikator Perlu Tindakan Anda</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="card card-xl-stretch mb-xl-8 bg-success h-100">
                            <div class="card-body p-5">
                                ...
                                <div class="fw-semibold text-white fs-7">Indikator Selesai Diverifikasi</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-5 mb-xl-10">
                        <div class="card-header border-0 pt-6">
                            <div class="card-title">
                                <h3 class="fw-bold m-0">Pemberitahuan Penting</h3>
                            </div>
                        </div>
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h3 class="fw-bold m-0">Progres Siklus Audit Anda</h3>
                        </div>
                    ...
                    <div class="card-body py-4">
                        <div class="row g-5 g-xl-8">
                            @forelse($auditperiodesDashboard as $periode)
                                {{-- Gunakan subset khusus untuk dashboard --}}
                                        ...
                                        <div class="card-body p-4 d-flex flex-column">
                                            ...
                                            <div class="progress" style="height: 25px;">
                                                @php
                                                    ...
                                                    // Hitung persentase untuk setiap status (gunakan round untuk pembulatan)
                                                    $p_selesai =
                                                        $total > 0
                                                ...
                                                @if ($p_selesai > 0)
                                                    <div class="progress-bar bg-success" role="progressbar"
                                                        ...
                                                        title="{{ $periode->status_counts['selesai'] }} Indikator Selesai">
                                                ...
                                                @if ($p_diajukan > 0)
                                                    <div class="progress-bar bg-info" role="progressbar"
                                                        ...
                                                        aria-valuemax="100" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="{{ $periode->status_counts['diajukan'] }} Indikator Diajukan">
                                                ...
                                                @if ($p_draft_dikerjakan > 0)
                                                    <div class="progress-bar bg-warning" role="progressbar"
                                                        ...
                                                        aria-valuemax="100" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="{{ $periode->status_counts['draft_dikerjakan'] }} Indikator Draft">
                                                        <small>{{ $periode->status_counts['draft_dikerjakan'] }}
                                                            Draft</small>
                                                    </div>
                                                @endif
                                                @if ($p_revisi > 0)
                                                    <div class="progress-bar bg-danger" role="progressbar"
                                                        ...
                                                        aria-valuemax="100" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="{{ $periode->status_counts['revisi'] }} Indikator Revisi">
                                            ...
                                            <small class="text-muted mt-2 d-block text-end">Indikator Terisi:
                            ...
                            @empty
                                <div class="col-12">
                                    <div class="alert alert-warning text-center">
                                        ...
                                        <a href="#" class="alert-link">Hubungi administrator jika ada
                                            masalah.</a>
                                    </div>
                                </div>
                            @endforelse
