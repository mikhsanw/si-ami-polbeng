...
<div class="panel">
    <div class="panel-body">
		<div class="form-group">
			...
			{!! html()->select("user_id", $user_id, isset($data) ? $data->user_id : null)->placeholder("Pilih")->class("form-select")->id("user_id") !!}
		</div>
		<div class="form-group">
			{!! html()->label()->class("control-label")->for("audit_periode_id")->text("Audit Periode") !!}
			{!! html()->select("audit_periode_id", $audit_periode_id, isset($data) ? $data->audit_periode_id : null)->placeholder("Pilih")->class("form-select")->id("audit_periode_id") !!}
		</div>
