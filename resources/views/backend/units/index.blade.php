...
<div class="card">
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar flex-row-fluid justify-content-end gap-5 me-3">
            @if(isset($id))
                {{-- Tombol ini hanya akan muncul jika variabel $parent ada --}}
                <a href="{{ route($page->code.'.index') }}" class="btn btn-light-danger me-3">
        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                @can($page->code.' create')
                    <a href="#" class="btn btn-primary btn-action action-create" data-title="Tambah" data-parent-id="{{ $id ?? '' }}" data-action="create" data-url="{{ config('master.app.url.backend').'/'.$page->url }}">
        ...
        <table id="datatable" class="table align-middle table-row-dashed fs-6 gy-5">
            <thead>
                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
					...
					<th class="text-center">User Pimpinan</th>
