            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5 me-3">
                ...
                <div id="kt_datatable_example_export_menu"
                    ...
                    <div class="menu-item px-3">
                        <a class="menu-link px-3" data-kt-export="copy">Copy to clipboard</a>
                    </div>
                    <div class="menu-item px-3">
                        <a class="menu-link px-3" data-kt-export="excel">Export as Excel</a>
                    </div>
                    <div class="menu-item px-3">
                        <a class="menu-link px-3" data-kt-export="csv">Export as CSV</a>
                    </div>
                    <div class="menu-item px-3">
                        <a class="menu-link px-3" data-kt-export="pdf">Export as PDF</a>
                    </div>
                </div>
