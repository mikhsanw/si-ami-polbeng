            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5 me-3">
                ...
                <div id="kt_datatable_example_export_menu"
                    ...
                    <div class="menu-item px-3">
                        <a href="{{ url(config('master.app.url.backend') . '/' . $page->url . '/generate-form4/' . $id) }}"
                            target="_blank" class="menu-link px-3">Generate Form
                            4</a>
                    </div>
                    <div class="menu-item px-3">
            ...
            <table id="datatable" data-id="{{ $id }}" class="table align-middle table-row-dashed fs-6 gy-5">
                <thead>
                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-center">Periode Unit</th>
