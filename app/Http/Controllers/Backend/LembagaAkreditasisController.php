...
class LembagaAkreditasisController extends Controller
{
    ...
    public function create()
    {
        ...
        $data = [
            'kategori'=> config('master.content.lembagaakreditasi.kategori')
        ];
    ...
    public function store(Request $request)
    {
        $request->validate([
					...
					'kategori' => 'required|'.config('master.regex.json'),
        ]);
