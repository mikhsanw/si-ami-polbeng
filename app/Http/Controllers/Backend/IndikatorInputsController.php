...
class IndikatorInputsController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $user = $request->user();
            $data=$this->model::with('indikator')->get();
    ...
    {
        $request->validate([
					'nama_variable' => 'required|'.config('master.regex.json'),
					'label_input' => 'required|'.config('master.regex.json'),
					'tipe_data' => 'required|'.config('master.regex.json'),
